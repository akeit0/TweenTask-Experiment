...
### MustUseThisAnalyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [MustUseThisAnalyzer.Sample.csproj](../MustUseThisAnalyzer.Sample/MustUseThisAnalyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### MustUseThisAnalyzer.Tests
